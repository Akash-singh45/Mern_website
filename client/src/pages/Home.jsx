    ...
    <div className="bg-gradient-to-br from-white to-slate-100 text-gray-900 font-sans">
      ...
      <section className="min-h-[80vh] flex flex-col-reverse lg:flex-row items-center justify-between px-4 sm:px-6 md:px-16 py-12 sm:py-16 gap-8 sm:gap-16 bg-gradient-to-br from-white via-slate-50 to-slate-100">
        <div className="max-w-2xl animate-fade-in-up text-center lg:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 drop-shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
            <Link to="/internships">
              <Button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-6 sm:px-8 py-3 rounded-full text-base sm:text-lg shadow-lg transition duration-300 ease-in-out">
                🎓 Apply for Internship
              </Button>
            </Link>
            <Link to="/partner">
              <Button variant="outline" className="border-indigo-500 text-indigo-600 hover:bg-indigo-50 px-6 sm:px-8 py-3 rounded-full text-base sm:text-lg transition duration-300 ease-in-out">
                🏢 Partner with Us
              </Button>
            </Link>
          </div>
      ...
      {/* Stats Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 md:px-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 text-center">
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-lg transition-all">
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-700 mb-2">1200+</h2>
          <p className="text-gray-600 text-sm sm:text-base">Interns trained across AI, ML, Web Dev & Python</p>
        </div>
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-lg transition-all">
          <h2 className="text-3xl sm:text-4xl font-bold text-purple-700 mb-2">90%+</h2>
          <p className="text-gray-600 text-sm sm:text-base">Placed or hired through real-world project evaluations</p>
        </div>
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-lg transition-all">
          <h2 className="text-3xl sm:text-4xl font-bold text-pink-600 mb-2">50+</h2>
          <p className="text-gray-600 text-sm sm:text-base">Startups and companies hiring through AdacodeAI</p>
        </div>
      </section>

      {/* Internship Info Section */}
      <section className="bg-gradient-to-br from-violet-50 to-white py-12 sm:py-20 px-4 sm:px-6 md:px-28 rounded-2xl sm:rounded-3xl shadow-xl mt-12 sm:mt-20">
      ...
      <section className="bg-gradient-to-br from-indigo-50 to-white py-12 sm:py-20 px-4 sm:px-6 md:px-20 rounded-2xl sm:rounded-3xl shadow-xl mt-12 sm:mt-20">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <img
          ...
          />
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold text-indigo-700 mb-4">Struggling to Hire? Let’s Change That.</h2>
  ...
  <div className="grid md:grid-cols-2 gap-8 sm:gap-10 items-center">
    ...
    <div className="max-w-xl mx-auto md:mx-0">
      ...
      <section className="bg-gradient-to-br from-white to-slate-100 py-12 sm:py-24 px-4 sm:px-6 md:px-28 flex flex-col-reverse lg:flex-row items-center gap-8 sm:gap-16">
        ...
        <div className="max-w-xl animate-fade-in-right text-center lg:text-left">
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-500">
          ...
          <Link to="/about">
            <Button className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-full text-base sm:text-lg font-semibold shadow">
              Learn More About Us
            </Button>
          </Link>
        </div>
      ...
      {/* Success Stories */}
      <section className="bg-white py-12 sm:py-24 px-4 sm:px-6 md:px-20">
      ...
      <footer className="bg-gray-900 text-white py-12 mt-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm sm:text-base">Email: adacodeai@gmail.com</p>
            <p className="text-gray-400 text-sm sm:text-base">Location: India (Remote)</p>
          </div>
          <div>
